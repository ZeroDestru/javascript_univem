...
async function saveProduto(event) {
    ...
    if (resposta.status == 200) {
        ...
        if(document.querySelector("input[name=nome]").value == '') {
            const inp = document.getElementsByClassName('Nome')[0];
            inp.style.color = 'red';
            inp.style.fontSize = '25';}

        if(document.querySelector("input[name=descricao]").value == '') {
            const inp = document.getElementsByClassName('Descricao')[0];
            inp.style.color = 'red';
            inp.style.fontSize = '25';}

        if(document.querySelector("input[name=preco]").value == '') {
            const inp = document.getElementsByClassName('Preco')[0];
            inp.style.color = 'red';
            inp.style.fontSize = '25';}

        if(document.querySelector("input[name=estoque]").value == '') {
            const inp = document.getElementsByClassName('Estoque')[0];
            inp.style.color = 'red';
            inp.style.fontSize = '25';}

        if(document.querySelector("input[name=image]").value == '') {
            const inp = document.getElementsByClassName('URL')[0];
            inp.style.color = 'red';
            inp.style.fontSize = '25';}
